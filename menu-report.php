            ...
            <!-- Student Management-->
                <div class="w3-third">
                    <div class="w3-card-2 " style="min-height:200px">
                        <a href="ui_connect/report/roi.php" class = "textdecoration">
                            <img src="img/images/pay.png" class="w3-hover-opacity" style="width:100%; height: 385px; ">
                 ...
                 <div class="w3-third">
                    <div class="w3-card-2 w3-display-container"  style="min-height:200px">
                        <!--<a href="ui_connect/email_management/Email_Management.php"> -->
                            <img src="img/images/m.png" class="w3-hover-opacity" style="width:100%; height: 385px;">
                              <div class="w3-display-middle w3-display-hover">  
                                <div class="w3-panel w3-blue-grey w3-card-2">
                                    <a href="ui_connect/report/Report.php.php" class = "textdecoration"><p>Thai</p></a>
                                </div>
                                    <p>&nbsp;</p>
                                <div class="w3-panel w3-orange w3-card-4 ">
                                    <a href="ui_connect/report/Report.php.php" class = "textdecoration"><p>Non-Thai</p></a>
                                </div>
                            </div>
                        <!--</a>-->
                ...
                <div class="w3-third">
                    <div class="w3-card-2 w3-display-container"  style="min-height:200px">
                        <!--<a href="ui_connect/email_management/Email_Management.php"> -->
                            <img src="img/images/a.png" class="w3-hover-opacity" style="width:100%; height: 385px;">
                              <div class="w3-display-middle w3-display-hover">  
                                <div class="w3-panel w3-blue-grey w3-card-2">
                                    <a href="ui_connect/email_management/Email_Management.php" class = "textdecoration"><p>Overview</p></a>
                                </div>
                                    <p>&nbsp;</p>
                                <div class="w3-panel w3-orange w3-card-4 ">
                                    <a href="ui_connect/activity_management/activity.php" class = "textdecoration"><p>Search graph</p></a>
                                </div>
                            </div>
                        <!--</a>-->
