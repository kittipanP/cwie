...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2017 at 02:31 PM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `ucfirst` (`str_value` VARCHAR(5000)) RETURNS VARCHAR(5000) CHARSET latin1 BEGIN
...
(3, 'Presentation', 'It is an automated email for your upcoming presentation. Please find the details below.', NULL, 'Western Digital Corporation (and its subsidiaries) E-mail Confidentiality Notice & Disclaimer:\r\nThis e-mail and any files transmitted with it may contain confidential or legally privileged information of WDC and/or its affiliates, and are intended solely for the use of the individual or entity to which they are addressed. If you are not the intended recipient, any disclosure, copying, distribution or any action taken or omitted to be taken in reliance on it, is prohibited. If you have received this e-mail in error, please notify the sender immediately and delete the e-mail in its entirety from your system.'),
(4, 'Trainee Presentation', 'It is an automated email for the upcoming presentation of the following trainee:', NULL, 'Western Digital Corporation (and its subsidiaries) E-mail Confidentiality Notice & Disclaimer:\r\nThis e-mail and any files transmitted with it may contain confidential or legally privileged information of WDC and/or its affiliates, and are intended solely for the use of the individual or entity to which they are addressed. If you are not the intended recipient, any disclosure, copying, distribution or any action taken or omitted to be taken in reliance on it, is prohibited. If you have received this e-mail in error, please notify the sender immediately and delete the e-mail in its entirety from your system.'),
...
(2, 'SUTTIPONG', 'NAWONG', NULL, NULL, NULL, NULL, 2, 2, NULL, NULL, 1, 4),
...
(2, 'Let''s Discover South Africa', 'Please join us and welcome South Africa with us.', '15:00:00', '17:00:00', '2017-03-24', 'SE-COM-003', 3, '2017-03-16 01:59:44'),
(3, 'Let''s Discover Pakistan', 'Please join us and discover Pakistan with us.', '15:00:00', '17:00:00', '2017-03-24', 'SE-COM-003', 3, '2017-03-16 02:08:26'),
(4, 'Let''s Discover Malaysia', 'Please join us and discover Malaysia with us', '15:00:00', '17:00:00', '2017-03-28', 'SE-COM-003', 3, '2017-03-16 02:07:34'),
(7, 'Let''s Discover Thailand', 'Please join us and discover Thailand with us.', '15:00:00', '17:00:00', '2017-04-05', 'SE-COM-003', 3, '2017-03-16 02:07:05'),
(9, 'WD Songkran Festival', 'Please join us and celebrate Songkran with us', '15:00:00', '17:00:00', '2017-04-05', 'SE-COM-003', 3, '2017-03-16 09:20:53'),
(19, 'mofo', 'work mofo', '14:00:00', '16:00:00', '2017-04-05', 'SE-COM-003', 3, '2017-03-20 13:17:25');
...
(2, 2, 4, '2017-03-14 04:42:01'),
(3, 3, 4, '2017-03-15 03:58:05'),
(4, 4, 4, '2017-03-15 04:38:14'),
(7, 7, 4, '2017-03-16 02:07:05'),
(9, 9, 4, '2017-03-16 09:20:53'),
(19, 19, 3, '2017-03-20 13:17:25');
...
CREATE TABLE `trainee_info_has_trainee_presentation` (
  ...
  `trainee_id` varchar(45) NOT NULL,
  `pre_trainee_id` int(11) NOT NULL,
...
INSERT INTO `trainee_info_has_trainee_presentation` (`trainee_presentation_id`, `trainee_id`, `pre_trainee_id`, `created_detail`) VALUES
(1, 'RSMBC16_280', 8, '2017-03-16 08:04:12');
...
(1, '2017-04-17', '09:00:00', '10:00:00', '00:20:00', 'Let''s see', NULL, 'SE-COM-003', 3, '2017-03-16 02:47:14'),
(8, '2017-05-05', '14:00:00', '17:00:00', '00:20:00', NULL, NULL, 'SE-COOM-03', 3, '2017-03-16 08:04:11');
...
--
ALTER TABLE `schedule_email_act`
  MODIFY `sch_email_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
...
--
ALTER TABLE `trainee_duration`
  MODIFY `trainee_duration_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `trainee_info_has_trainee_activity`
--
ALTER TABLE `trainee_info_has_trainee_activity`
  MODIFY `assign_act_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `trainee_info_has_trainee_presentation`
--
ALTER TABLE `trainee_info_has_trainee_presentation`
  MODIFY `trainee_presentation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `trainee_presentation`
  MODIFY `presentation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
