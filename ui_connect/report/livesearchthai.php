...
<?php require_once '../../db_connect/dbconnection.php'; //connect to database?>
...
<html>
 <head>
   <?php //All the meta and css links
    ...
    <title>Search graph thai students</title>
 ...
 <body style=" background: url(pictures/report.png) no-repeat center center fixed;
  ...
  <div class="w3-container w3-theme-d2 w3-left-align w3-center"
    ...
    <h2>Thai Students Searching</h2>
  </div>


  <form method="post" action="showgraphthai.php"> <!--Sent this form to pieandbarchart.php-->
    ...
    <div class="field" style="width:700px;" id="searchform" >
      <label for="university" class="col-sm-2 col-form-label w3-center">University</label>
    ...
    <div class="field" style="width:700px; height:43px;" id="searchform" >
      ...
      <select id="dropdown" name="type" required="" oninvalid="this.setCustomValidity('Oops..! Please select type')" oninput="setCustomValidity('')">
        ...
        <option value="ins_name">University</option>
      </select>
    </div>
