...
$sql =' SELECT c.s_fname ,c.s_lname ,a.degree_name,COUNT(*) AS num
        FROM degree_info a
        INNER JOIN education_info b ON a.degree_id = b.degree_id
           ...
           <div class="container">
             ...
             <div class="navbar-collapse collapse" style="font-size:14px"><b>
               <ul class="nav navbar-nav navbar-right">
                 ...
                 <li class="active"><a href="nonthaidegree.php">DEGREE</a></li>
