            ...
            <!-- Header -->
                <header class="w3-container w3-theme w3-padding w3-round"  id="myHeader">
                    <div class="w3-center">
                        ...
                        <h3 class="w3-xxlarge w3-animate-right">ROI Project</h3>
                    </div>
                </header>
            </div>
         </div>
...
<div class="left"> <!--Open div tag of left box of search form-->
  <div class="w3-container w3-card-4" style="margin:0 0 0 0; border-radius: 5px; background-color: #FFFFFF; padding: 20px;">
    <form method="post" action="searchroi2.php"><h3><b>Advance Search:</b></h3>
      <br>
       
        <div class="field" id="searchform" >
        <label for="type">Student Origin</label>
      ...
      <input type="text" id="project" name="project_fname" placeholder="Project..">
</div>
...
<div class="field" id="searchform" >
      ...
      <input type="text" id="code" name="trainee_code" placeholder="Code..">
       ...
       <div class="field" id="searchform" >
      <label for="fname">Trainee's name</label>
...
<div class="field" id="searchform" >
      ...
      <input type="text" id="supervisor" name="spv_fname" placeholder="Supervisor..">
</div>
     <div class="field" id="searchform" >
