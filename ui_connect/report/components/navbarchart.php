      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <div class="small-logo-container">
            <a class="small-logo" href="#">Thai Students</a>
          </div>
        </div>
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="active"><a href="thaiplant.php">PLANT</a></li>
                      <li><a href="thailocation.php">LOCATION</a></li>
                      <li><a href="thaistatus.php">STATUS</a></li>
                      <li><a href="thaidegree.php">DEGREE</a></li>
                      <li><a href="thaidepartment.php">DEPARTMENT</a></li>
                      <li><a href="thaiuniversity.php">UNIVERSITY</a></li>
                      <li><a href="thaimajor.php">MAJOR</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 big-logo-container">
            <h1 class="big-logo">Thai Students</h1>
          </div><!--/.col-xs-12 -->
        </div><!--/.row -->
      </div><!--/.container -->
    </div><!--/.container-fluid -->
