...
$sql =' SELECT  c.s_fname ,c.s_lname ,a.location_name,count(*) AS num
        FROM location a
        INNER JOIN  trainee_info b ON a.location_id = b.location_id
             ...
             <div class="container">
               ...
               <div class="navbar-collapse collapse" style="font-size:14px"><b>
                 <ul class="nav navbar-nav navbar-right">
                   ...
                   <li class="active"><a href="nonthailocation.php">LOCATION</a></li>
