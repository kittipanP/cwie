...
$sql =' SELECT c.s_fname ,c.s_lname ,a.major_name,COUNT(*) AS num
        FROM major_info a
        INNER JOIN education_info b ON a.major_id = b.major_id
           ...
           <div class="container">
             ...
             <div class="navbar-collapse collapse" style="font-size:20px"><b>
               <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="thaimajor.php" class="animsition-link">MAJOR</a></li>
               </ul>
             </div><!--/.nav-collapse --></b>
           </div>
         </div>
...
<!--Bar Chart--><canvas id="horizonbarChart" width="1580" height="1500"></canvas>
                <?php require_once 'components/horizonbarchart.php' ?></div>
<?php
    //Footer
