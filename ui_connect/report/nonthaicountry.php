...
$sql =' SELECT d.s_fname ,d.s_lname ,a.country_name,count(*) AS num
        FROM country_list a
        INNER JOIN student_address b ON a.country_id = b.country_id
        INNER JOIN student_info d ON d.s_id = b.s_id
        LEFT JOIN application e  ON e.s_id = d.s_id
        WHERE a.country_name != "Thailand"
           ...
           <div class="container">
             ...
             <div class="navbar-collapse collapse" style="font-size:14px"><b>
               <ul class="nav navbar-nav navbar-right">
                     ...
                     <li><a href="nonthaidepartment.php">DEPARTMENT</a></li>
                 <li class="active"><a href="nonthaicountry.php">COUNTRY</a></li>
...
<!--Pie Chart--><canvas id="horizonbarChart" width="1580" height="2500"></canvas>
