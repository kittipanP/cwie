...
$sql =' SELECT c.s_fname ,c.s_lname ,a.host_name, COUNT(*) AS num
        FROM  host_university a
        INNER JOIN non_thai b ON a.host_id = b.host_id
        INNER JOIN student_info c ON b.s_id = c.s_id
...
<head>
    ...
    <title>Non-Thai host university</title>
             ...
             <div class="container">
               ...
               <div class="navbar-collapse collapse" style="font-size:14px"><b>
                 <ul class="nav navbar-nav navbar-right">
                   ...
                   <li class="active"><a href="nonthaihostuniversity.php">HOST UNIVERSITY</a></li>
                 </ul>
               </div><!--/.nav-collapse --></b>
             </div>
           </div>
...
</div>                           <?php require_once 'components/linechart.php' ?>
<?php
    //Footer
