...
$sql =' SELECT c.s_fname ,c.s_lname ,a.c_name,COUNT(*) AS num
        FROM chanel a
        INNER JOIN non_thai b ON a.c_id = b.c_id
           ...
           <div class="container">
             ...
             <div class="navbar-collapse collapse" style="font-size:14px"><b>
               <ul class="nav navbar-nav navbar-right">
                 ...
                 <li class="active"><a href="nonthaichannel.php">CHANNEL</a></li>
