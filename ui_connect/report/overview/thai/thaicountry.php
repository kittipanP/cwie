...
<div class="container" >
      <a class="btn btn-1" href="overview/thai/plant.php">PLANT</a>
...
<div class="w3-container w3-blue-gray w3-center"><!--Header for pie chart-->
  <h2>Total student for each Country (Pie Chart)</h2>
</div>
...
<div class="w3-container w3-blue-gray w3-center"><!--Header for bar chart-->
  <h2>Total student for each Country (Bar Chart)</h2>
</div>
...
<div class="w3-container w3-blue-gray w3-center"><!--Header for bar chart-->
  <h2>Total student for each Country (Line Chart)</h2>
</div>
