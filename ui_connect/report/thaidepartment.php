           ...
           <div class="container">
             ...
             <div class="navbar-collapse collapse" style="font-size:20px"><b>
               <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="thaidepartment.php" class="animsition-link">DEPARTMENT</a></li>
...
<!--Bar Chart--><canvas id="horizonbarChart" width="1580" height="2000"></canvas>
