            ...
            <fieldset>
                    ...
                    <?php 
                        ...
                        $query = mysqli_query($link, "SELECT activity_id, activity_name,activity_detail, start_time , end_time , activity_date,
                                activity_date, activity_room, IFNULL(bldg_name,'Unassigned')bldg_name, IFNULL(status_desc, 'Unassigned') status_desc
                    ...
                    <br/>
                    <textarea class=" textarea" rows="5" cols="50" style = "resize: none;" name ="act_detail_ed" value="" placeholder="Details"><?php echo $a_detail ?></textarea>
                    <br/>
                    <div style="color: red;">
