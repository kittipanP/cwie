    ...
    <form method="post" action="">
            ...
            <fieldset>
                    ...
                    <?php 
                        ...
                        //$query = mysqli_query($link, "SELECT * from trainee_activity where activity_id = $id");
                        $query = mysqli_query($link, "SELECT activity_id, activity_name,activity_detail, start_time , end_time , activity_date,
                                activity_date, activity_room, bldg_name, IFNULL(trainee_status_desc, 'Unassigned') trainee_status_desc
                                FROM trainee_info_has_trainee_activity 
                                LEFT JOIN trainee_status ON trainee_status.trainee_status_id = trainee_info_has_trainee_activity.trainee_status_id
                        ...
                        while ($row= mysqli_fetch_array($query)){
                               $a_name = $row['activity_name'];
                                ...
                                $a_type = $row['trainee_status_desc'];
