	<?php	
		...
		mysqli_select_db($MyConnect, $database_MyConnect);
			$query_studentSet_all = "SELECT student_info.s_id, title.title_name, student_info.s_fname, student_info.s_lname, student_status.status_desc, major_info.major_name, degree_info.degree_name, university_info.uni_name, collage_info.collage_name
			FROM student_info
