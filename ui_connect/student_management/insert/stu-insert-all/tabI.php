                ...
                <div class="w3-row-padding w3-center w3-margin-top">
                  ...
                  <div class="w3-third">
                    <div>
                        ...
                        <select name="major_id" id="majorSelect" class="chosen" data-live-search="true" title="Please select your" style="width: 100%; ">
              ...
              <fieldset>
                ...
                <div class="w3-row-padding w3-center w3-margin-top">
                  ...
                  <div class="w3-third">
                        ...
                        <select name="lg_id" id="majorSelect" title="Please select language" style="width: 100%; ">
