    ...
    <div class="w3-grey">
      <div class="w3-container w3-dark-grey w3-padding w3-center" style="width:<?php echo htmlentities($row_evaRec['eva_onlineTest'], ENT_COMPAT, 'utf-8');?>%"><?php echo htmlentities($row_evaRec['eva_onlineTest'], ENT_COMPAT, 'utf-8');?>%</div>
    </div>
    <p>Pre-English Test</p>
    <div class="w3-grey">
      <div class="w3-container w3-dark-grey w3-padding w3-center" style="width:<?php echo htmlentities($row_evaRec['eva_preTest'], ENT_COMPAT, 'utf-8');?>%"><?php echo htmlentities($row_evaRec['eva_preTest'], ENT_COMPAT, 'utf-8');?>%</div>
    </div>
    <p>Post-English Test</p>
    <div class="w3-grey">
      <div class="w3-container w3-dark-grey w3-padding w3-center" style="width:<?php echo htmlentities($row_evaRec['eva_postTest'], ENT_COMPAT, 'utf-8');?>%"><?php echo htmlentities($row_evaRec['eva_postTest'], ENT_COMPAT, 'utf-8');?>%</div>
    </div>
    <p>
