...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  ...
  $theValue = function_exists("mysqli_real_escape_string") ? mysqli_escape_string(dbconnect(),$theValue) : mysqli_real_escape_string(dbconnect(),$theValue) ;//+dbconnect() 
...
if (isset($_POST['uname'])) {
  ...
  mysqli_select_db($MyConnect, $database_MyConnect); // swab $MyConnect, $database_MyConnect
  
  $LoginRS__query=sprintf("SELECT email, password FROM login_info WHERE email=%s AND password=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysqli_query($MyConnect,$LoginRS__query) or die(mysqli_error());
